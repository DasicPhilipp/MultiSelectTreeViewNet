...
namespace System.Windows.Controls {
    internal class BorderSelectionLogic : IDisposable {
        ...
        private void OnMouseUp(object sender, MouseButtonEventArgs e) => this.OnMouseUpInternal(e);

        private void OnMouseUpInternal(MouseEventArgs e) {
            this.EndAction();
        ...
        private void OnMouseMove(object sender, MouseEventArgs e) {
            ...
            foreach (MultiSelectTreeViewItem item in MultiSelectTreeView.GetEntireTreeRecursive(this.treeView, false, false)) {
                ...
                if (!foundFocusItem && currentPoint.X >= itemLeft && currentPoint.X <= itemRight && currentPoint.Y >= itemTop && currentPoint.Y <= itemBottom) {
